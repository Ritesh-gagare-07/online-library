      ...
      <div class="topbar">
        ...
        <div class="profile-dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="profile.php" class="btn btn-primary w-100 mt-2">👤 View Profile</a>
          </div>
        </div>
      </div>
                ...
                <div class="card shadow">
                  ...
                  <div class="card-body">
                    ...
                    <?php if ($book['fine'] > 0 && !$book['fine_paid']): ?>
                      ...
                      <form action="ajax/pay_fine.php" method="POST" class="d-inline">
...
<?php if (!empty($book['url'])): ?>
   <a href="<?= htmlspecialchars($book['url']) ?>" target="_blank" class="btn btn-primary btn-sm mt-2">📖 Read Book</a>
<?php endif; ?>

<!-- Return Book button -->
<form action="ajax/return_book.php" method="POST" class="mt-2 d-inline">  
   <input type="hidden" name="book_id" value="<?= $book['id'] ?>">  
   <button class="btn btn-danger btn-sm">📤 Return Book</button>  
</form>
